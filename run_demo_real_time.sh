...
python3 ./capture_eval_real_time.py --hama-port-path $HAMA_PORT_PATH --spectra-port-path $SPECTRA_PORT_PATH --spectral-data-path $SPECTRAL_SAMPLE_FILENAME